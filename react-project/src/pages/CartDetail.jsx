...
export default function CartDetail() {
  ...
  return (
    <div>
      ...
      <Card.Group>
        <Card fluid>
          <Card.Content>
            ...
            <Image floated="right" size="tiny" src='https://i.dr.com.tr/cache/600x600-0/originals/0000000052566-1.jpg' />
            <Card.Header>Çalıkuşu</Card.Header>
            <Card.Meta>Yazar :  Reşat Nuri Güntekin</Card.Meta>
            <Card.Meta>Sayfa Sayısı :  160</Card.Meta>
            <Card.Meta>Fiyat : 150</Card.Meta>
      ...
      <div style={{marginLeft: 690, marginTop: 90}}>
        <Button size="20" color="google plus" >
        Sepeti Onayla
      </Button>
      </div>
